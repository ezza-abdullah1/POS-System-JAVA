...
Image scaledImage = headerIcon.getImage().getScaledInstance(getWidth(), 100, Image.SCALE_SMOOTH); // Scaled to full width
...
headerPanel.add(titleLabel, BorderLayout.SOUTH);
    ...
    // Set the background and foreground of the table header to ensure they retain their color
    ...
    private void setButtonProperties(RoundedButton[] buttons) {
        for (RoundedButton button : buttons) {
            ...
            button.setFocusPainted(false);
             ...
             button.setPreferredSize(new Dimension(button.getPreferredSize().width, button.getPreferredSize().height - 28));
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new UserTableView("Cashier"));
    }
}
